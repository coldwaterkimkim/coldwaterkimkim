...
문제와 감각을 실제로 작동하는 제품 형태로 바꾸는 데 관심이 있습니다. 음악, 글, 웹사이트, iOS/macOS 앱, 작은 MVP를 만들며 기획에서 구현, 검증까지 직접 밀어붙이는 연습을 하고 있습니다.

아래 프로젝트들은 제가 최근에 직접 기획하고 구현한 작업들입니다. 코드만 보기보다, 어떤 문제를 잡고 어떤 흐름으로 검증했는지를 함께 봐주시면 좋습니다.
...
- 문제를 먼저 좁히고, 작게라도 실제로 만져볼 수 있는 흐름을 만듭니다.
- 랜딩, 카피, 인터랙션, 데이터 흐름, 검증 지표를 한 덩어리로 봅니다.
- 완성형 서비스라고 과장하기보다, MVP와 프리토타입의 경계를 명확히 두려고 합니다.
- 혼자 만든 결과물도 사용자 반응과 지표 앞에 세우는 연습을 하고 있습니다.

## Current Focus

- 사용자의 감정과 습관을 다루는 작은 제품 실험
- iOS/macOS 네이티브 앱 MVP
- 개인 홈페이지와 로컬-first 운영 도구
- AI coding agent를 제품 오너 관점에서 더 잘 지휘하는 방식

## Contact

- Website: https://coldwaterkim.com/
